...
export default function AssistantPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0F] flex flex-col">
      <header className="sticky top-0 z-50 border-b border-red-600/20 bg-[#0B0B0F]/90 backdrop-blur-xl">
      ...
      <div className="sticky bottom-0 border-t border-red-600/20 bg-[#0B0B0F]/95 backdrop-blur-xl px-4 py-3">
