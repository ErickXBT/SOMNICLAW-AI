...
export default function GenerativeAiPage() {
  return (
    <div className="min-h-screen bg-[#0b0000] flex items-center justify-center px-6">
      ...
      >
        <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-purple-400 bg-clip-text text-transparent animate-gradient mb-6">
          SOMNICLAW GENERATIVE AI
        </h1>
        <p className="text-lg text-gray-400 mb-10 leading-relaxed">
          Neural generative engine that transforms prompts into cyberpunk
          reality. Visual AI built for digital dominance. Coming soon.
        </p>
        <Link
          to="/"
